		...
		<aside id="locationSearch{$widgetLocationItem.id}" class="locationSearch">
			<form method="get" action="#">
				<p>
					...
					<input type="text" id="locationSearchAddress{$widgetLocationItem.id}" name="locationSearchAddress" />
				...
				<p>
					<input type="submit" id="locationSearchRequest{$widgetLocationItem.id}" name="locationSearchRequest" value="{$lblShowDirections|ucfirst}" />
				</p>
			</form>
		</aside>
	{/option:widgetLocationSettings.directions}
